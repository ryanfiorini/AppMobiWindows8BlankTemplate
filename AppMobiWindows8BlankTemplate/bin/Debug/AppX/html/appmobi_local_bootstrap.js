...
var debug=false;
//debug=true;
if(debug)AppMobiLocalFlag=true;
...
function loadLocalhostScript() {
	...
	script.onload = function() {
		if(debug) console.log('got localhost appmobi.js');
	}
...
function loadStaticScript() {
	...
	//if fail, just log
	script.onerror = function() {
		if(debug) console.log('unable to load any appmobi.js');
	}
	script.onload = function() {
		if(debug) console.log('got local static appmobi.js');
	}
